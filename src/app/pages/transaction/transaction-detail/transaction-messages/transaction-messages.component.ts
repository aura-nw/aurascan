    ...
    this.transactionDetail?.messages.forEach((data, index) => {
      ...
      switch (data['@type']) {
        case this.eTransType.Send:
          result.push({
            key: 'From Address',
            value: this.nameTagService.getNameTag(data?.from_address),
            link: { url: '/account', data: data?.from_address, nameTag: true },
          });
          result.push({
            key: 'To Address',
            value: this.nameTagService.getNameTag(data?.to_address),
        ...
        case this.eTransType.GetReward:
          ...
          result.push({
            ...
            value: this.nameTagService.getNameTag(data?.delegator_address),
        ...
        case this.eTransType.GrantAuthz:
          result.push({
            key: 'Granter',
            value: this.nameTagService.getNameTag(data?.granter),
            link: { url: '/account', data: data?.granter, nameTag: true },
          });
          result.push({
            key: 'Grantee',
            value: this.nameTagService.getNameTag(data?.grantee),
        ...
        case this.eTransType.ExecuteContract:
          ...
          result.push({
            key: 'Contract',
            value: this.nameTagService.getNameTag(data?.contract),
            link: { url: '/contracts', data: data?.contract, nameTag: true },
          });
          result.push({
            key: 'Sender',
            value: this.nameTagService.getNameTag(data?.sender),
        ...
        case this.eTransType.InstantiateContract2:
          ...
          result.push({
            key: 'Contract',
            value: this.nameTagService.getNameTag(this.getDataJson('_contract_address')),
        ...
        case this.eTransType.StoreCode:
          result.push({
            key: 'Sender',
            value: this.nameTagService.getNameTag(data?.sender || data?.validator_address),
        ...
        case this.eTransType.VoteV2:
          ...
          result.push({
            key: 'Voter',
            value: this.nameTagService.getNameTag(data.voter),
        ...
        case this.eTransType.SubmitProposalTxV2:
          ...
          result.push({
            key: 'Proposer',
            value: this.nameTagService.getNameTag(data.proposer),
        ...
        case this.eTransType.DepositV2:
          ...
          result.push({
            key: 'Depositor',
            value: this.nameTagService.getNameTag(data.depositor),
        ...
        case this.eTransType.ModifyWithdrawAddress:
          ...
          result.push({
            ...
            value: this.nameTagService.getNameTag(data.withdraw_address),

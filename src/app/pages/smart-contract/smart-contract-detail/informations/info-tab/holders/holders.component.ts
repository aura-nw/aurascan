...
export class HoldersComponent implements OnInit, OnChanges {
  @Input() keyWord = '';
  loading = true;
  mockData = [
    {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    if(this.mockData) {
      const filterData = this.mockData.filter(data => data.name.includes(this.keyWord) || data.hashCode.includes(this.keyWord));
      this.pageData = {

...
export class PrivateNameTagComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  templates: Array<TableTemplate> = [
    ...
    {matColumnDef: 'cosmosAddress', headerCellDef: 'Cosmos Add', headerWidth: 190},
    {matColumnDef: 'evmAddress', headerCellDef: 'EVM Add', headerWidth: 190},
    {matColumnDef: 'type', headerCellDef: 'Type', headerWidth: 80},
    {matColumnDef: 'name_tag', headerCellDef: 'Private Name Tag', headerWidth: 150},
    {matColumnDef: 'createdAt', headerCellDef: 'Added Time', headerWidth: 130},

...
@Component({
  selector: 'app-evm-write-as-proxy',
  templateUrl: './evm-write-as-proxy.component.html',
  styleUrls: ['./evm-write-as-proxy.component.scss'],
})
export class EvmWriteAsProxyComponent implements OnChanges {

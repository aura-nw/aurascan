...
@NgModule({
  declarations: [EvmContractsListComponent, EvmContractsDetailComponent, EvmOverviewComponent, EvmContractInfoComponent, EvmContractContentComponent, EvmCodeComponent, EvmReadComponent, EvmWriteComponent, EvmContractComponent],
  imports: [
    CommonModule,

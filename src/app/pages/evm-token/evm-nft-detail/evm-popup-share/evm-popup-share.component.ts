...
@Component({
  ...
  templateUrl: './evm-popup-share.component.html',
  styleUrls: ['./evm-popup-share.component.scss'],
})
export class EvmPopupShareComponent implements OnInit {
  isLoading = false;
  walletAccount: any;
  shareLink = '';
  ...
  constructor(
    public dialogRef: MatDialogRef<EvmPopupShareComponent>,

...
@Component({
  selector: 'app-evm-token-market',
  templateUrl: './evm-token-market.component.html',
  styleUrls: ['./evm-token-market.component.scss'],
})
export class EvmTokenMarketComponent implements OnInit {

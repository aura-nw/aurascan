...
@Component({
  ...
  templateUrl: './evm-token-inventory-tab.component.html',
  styleUrls: ['./evm-token-inventory-tab.component.scss'],
})
export class EvmTokenInventoryComponent implements OnInit {

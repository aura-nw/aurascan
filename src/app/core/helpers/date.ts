...
export const formatWithSchema = (timestamp: Date | number, schema: string): string => format(timestamp, schema);

export const formatTime = (timestamp: Date | number): string => formatWithSchema(timestamp, 'h:mm a');

export const formatDateTime = (timestamp: Date | number): string =>
  formatWithSchema(timestamp, 'MMM d, yyyy - h:mm:ss a');

export const formatTimeInWords = (timestamp: Date | number): string =>
